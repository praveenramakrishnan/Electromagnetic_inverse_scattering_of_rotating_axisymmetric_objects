...
all the unknowns. Further, in \cite{noinoiselimitation}, 
...
so clear indication on the velocity field. Therefore, in this
case, we propose to define a cost function using all the
...
With  $\beta = 8\ 10^{-4}$ and SNR = 20 dB the errors become 108.1 percent using the data along backscattered direction  as opposed to 27.3 percent with the data on the full circle.
...
Finally, for  $\beta = 8\ 10^{-5}$, the reconstruction algorithm performs very poorly for the considered values of SNR. 
...
Finally, for $\beta = 8 \ 10^{-5}$, the results for the considered 

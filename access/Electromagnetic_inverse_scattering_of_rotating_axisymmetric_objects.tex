...
used in the second step to find the axial speed from the cross-polarized 
component. The authors were able to demonstrate
...
that the media are under rest. In the second step, the values from
...
celestial bodies \cite{dezutterrotatingsphere}, \cite{vanbladel},
...
results for all speeds that can be of practical interest.
